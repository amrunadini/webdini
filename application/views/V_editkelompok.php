    ...
    <section id="pricing" class="pricing">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Edit Data Kelompok</h2>
        </div>
        
        <?php
            foreach ($kelompok as $u) {
        ?>
        <form action="<?php echo base_url().'C_guru/updatekelompok'; ?>" method="POST">
          <table id="example1" class="table table-bordered table-hover" border="1px">
            <tr>
              <td>Tema</td>
              <td>
                <input type="hidden" name="id" value="<?php echo $u->id_kelompok ?>">
                <input type="text" name="tema" value="<?php echo $u->tema ?>">
              </td>
            </tr>
            <tr>
              <td>Link</td>
              <td><input type="text" name="link" value="<?php echo $u->link ?>"></td>
            </tr>
              <td></td>
