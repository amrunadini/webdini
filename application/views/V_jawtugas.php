  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="<?php echo base_url(); ?>index.php/C_guru"><span>Belajar ERD</span></a></h1>
  ...
  <!-- ======= Pricing Section ======= -->
    <section id="pricing" class="pricing">
      <div class="container">
        ...
        <table class="table">
            <form action="<?php echo site_url('C_guru/insertnilaitugas'); ?>" method="POST">

            <tr> 
            <th> ID SISWA </th> 
            <td> <input type="text" name="id_siswa" placeholder="ID SISWA"> </td> </tr> 
            <tr> 
            <th> ID TUGAS </th> 
            <td> <input type="text" name="id_tugas" placeholder="ID TUGAS">  </td> </tr> 
            <tr> 
            <th> Nilai </th>
