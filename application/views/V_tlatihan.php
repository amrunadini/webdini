  ...
  <!-- ======= Pricing Section ======= -->
    <section id="pricing" class="pricing">
      <div class="container">
        ...
        <table class="table">
          <form action="<?php echo site_url('C_guru/insertsoal'); ?>" method="POST">
            <tr>
              <th> ID Materi </th>
              <td>
            ...
            <tr>
              <th> Pilihan 1 </th>
              <td>
                <input type="text" name="pil1" placeholder="Pilihan1">
              </td>
            </tr>
            <tr>
              <th> Pilihan 2 </th>
              <td>
                <input type="text" name="pil2" placeholder="Pilihan2">
              </td>
            </tr>
            <tr>
              <th> Pilihan 3 </th>
              <td>
                <input type="text" name="pil3" placeholder="Pilihan3">
              </td>
            </tr>
            <tr>
              <th> Pilihan 4 </th>
              <td>
                <input type="text" name="pil4" placeholder="Pilihan4">
              </td>
            </tr>
            <tr>
              <th> Pilihan 5 </th>
              <td>
                <input type="text" name="pil5" placeholder="Pilihan5">
              </td>
            </tr>
            <tr>
              <th> Kunci Jawaban </th>
              <td>
                <input type="text" name="kunci" placeholder="Kunci">
              </td>
            </tr>
          </table>
          <br>
          ...
          <input type="reset" class="btn btn-danger"> <br> <br> <br>
          ...
          <table id="example1" class="table table-bordered table-hover" border="1px">
            ...
            <tbody>
              ...
              <tr>
                ...
                <th><?php echo $key->id_materi; ?></th>
                <th><?php echo $key->soal; ?></th>
                <th><?php echo $key->pil1; ?></th>
                <th><?php echo $key->pil2; ?></th>
                <th><?php echo $key->pil3; ?></th>
                <th><?php echo $key->pil4; ?></th>
                <th><?php echo $key->pil5; ?></th>
                <th><?php echo $key->kunci; ?></th>
              </tr>
              <?php
                }
              ?>
