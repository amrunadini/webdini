    ...
    <section id="pricing" class="pricing">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Atribut</h2>
          <p>Pada tahun ajaran baru, setiap siswa yang akan melanjutkan tingkat pendidikan yang selanjutnya akan mendaftarkan dirinya ke sekolah pilihannya. Pada saat pendaftaran, maka siswa akan dimintai data pribadinya. Maka, dari contoh gambar di bawah ini, pilih dan tariklah Atribut yang memungkinkan dari contoh gambar tersebut!</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="box" data-aos="zoom-in-right" data-aos-delay="200">
              <img src="/skripsidini/assets/img/siswa.png" class="img-fluid" alt="" data-aos="zoom-in">
              <p style="font-size: 11px;"><a href='https://pngtree.com/so/student'>student png from pngtree.com</a></p>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 mt-4 mt-md-0" >
            <form action="<?php echo base_url();?>index.php/C_siswa/atribut1" method="post">
