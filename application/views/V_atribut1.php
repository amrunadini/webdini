      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-10 col-md-20">
            <div class="box" data-aos="zoom-in-right" data-aos-delay="200" style="margin-left: 220px;">
              <ul>
                <li style="font-size: 20px;">Atribut merupakan karakteristik atau properti dari entitas atau relasi yang memberikan detail mengenai entitas atau relasi tersebut.</li>
              </ul>
            </div>
          </div>
